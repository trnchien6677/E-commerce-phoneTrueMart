...
class Xiaomi extends Component {
  ...
  <div id="content_top">
    <div className="row">
      <div className="col-md-11"><h3>Điện thoại Xiaomi</h3></div>
      <div className="col-md-1"><p style={{fontSize:"12px"}}><a href="http://localhost:3000/xiaomi" style={{textDecoration:"none"}}>Xem tất cả <i class="fas fa-caret-right"></i></a></p></div>
    </div>
