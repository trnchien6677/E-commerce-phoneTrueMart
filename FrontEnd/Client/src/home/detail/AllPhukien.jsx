...
class AllPhuKien extends Component {
    constructor(props) {
        super(props)
  ...
  render() {
    return (
      <div>
        ...
        <div className="col-md-3"> <p style={{marginLeft:"10px"}}>Home <i class="fas fa-caret-right"></i> Điện thoại <i class="fas fa-caret-right"></i> Phụ kiện</p></div>
               
            </div>
        <div className="searchkey mt-3 ml-6">
            <div className="row"> 
            
            <div className="col-md-4"> <h5 style={{marginLeft:"15px"}}>Phụ kiện điện thoại</h5></div> 
                    ...
                    <figcaption className="info-wrap" style={{marginLeft:"35px"}}>
                      ...
                      <div>
                        <a href="#" className="text-muted ml-4" style={{color:"black", fontWeight:"bold",fontSize:"19px",textDecoration:"none"}}>
                          <a href={"http://localhost:3000/detail-phukien-" + listpro.id}  style={{color:"black", fontWeight:"bold",fontSize:"19px",textDecoration:"none"}}>
