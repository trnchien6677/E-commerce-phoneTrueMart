...
class AllVivo extends Component {
    constructor(props) {
        super(props)
      ...
      componentDidMount(){
        ProductService.getProductAllVivo().then((res) => {
    ...
    render() {
        ...
        <div className="searchkey mt-2 ml-6">
            <div className="col-md-3"> <p style={{marginLeft:"10px"}}>Home <i class="fas fa-caret-right"></i> Điện thoại <i class="fas fa-caret-right"></i> Vivo</p></div>
               
            </div>
        <div className="searchkey mt-3 ml-6">
            <div className="row"> 
            
            <div className="col-md-4"> <h5 style={{marginLeft:"15px"}}>Điện thoại Vivo</h5></div> 
