...
class DetailProduct extends Component {
  constructor(props) {
    ...
    this.changeValueColor = this.changeValueColor.bind(this);
  ...
  AddCart(id, name, price, image,color) {
    ...
    add({ id: id, name: name, price: price, image: image, id_order,color:this.state.color},count);
    onChange();
                ...
                <div className="row">
                        ...
                        <div className="img-big-wrap">
                          <div>
                            <TransformWrapper>
                              <TransformComponent>
                                <img
                                  style={{ marginLeft: "80px",width:"600px",height:"500px" }}
                                  src={
                  ...
                  <main className="col-md-6">
                    <article className="product-info-aside">
                      ...
                      <div className="hihi mb-3">
                        <div className="row">
                          <div className="col-md-3">  Color :  <select onChange={this.changeValueColor}>
                            <option value="Đen">Vàng</option>
                            <option value="Đỏ">Đỏ</option>
                            <option value="Đỏ">Đen</option>
                          </select></div>
                          <div className="col-md-3">
                          <div className="hihi mb-3">
  Số lượng: <select onChange={this.changeValue}>
                      ...
                      <table className="table table-bordered">
                        <tbody>
                          <tr>
                            <th colSpan={2}>Kỹ thuật</th>
                          </tr>
                          <tr>
                            <td>Camera</td>
                            <td>{this.state.product.camera}</td>
                          </tr>
                          <tr>
                            <td>Màn hình</td>
                            <td>{this.state.product.display}</td>
                          </tr>
                          <tr>
                            <td>Hệ điều hành</td>
                            <td>{this.state.product.cpu}</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>Cao</td>
                            <td>{this.state.product.height} mm</td>
                          </tr>
                          <tr>
                            <td>Rộng</td>
                            <td>{this.state.product.width} mm</td>
                          </tr>
                          <tr>
                            <td>Dày</td>
                            <td>{this.state.product.thick} mm</td>
                          </tr>
                          <tr>
                            <th colSpan={2}>Hệ điều hành và CPU</th>
                          </tr>
                          <tr>
                            <td>Chip xử lý</td>
                            <td>
                              {this.state.product.cpu}
                              {this.state.product.operating}
                            </td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <div className="container-123">
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <h5>Điện thoại {this.state.product.name}</h5>
                 
                    <div className="cofihaha">{ ReactHtmlParser(this.state.product.description) }</div>
                  </div>
                  {/* col.// */}
                </div>
                {/* row.// */}
          ...
          <div className="container-2">
            ...
            <Carousel itemsToShow={6}>
              {this.state.productRe.map((listpro) => (
                <div className="product-all mt-1">
                  ...
                  <div className="product-name">
                    <a
                      href={
                        "http://localhost:3000/detail-product/" + listpro.id
                      }
                    >
                      {listpro.name}
                    </a>
                  ...
                  <div className="product-price">
                    <NumberFormat
                      value={listpro.price-(listpro.price*listpro.discount/100)}
                      displayType={"text"}
                      thousandSeparator={true}
                    />{" "}
                    đ
